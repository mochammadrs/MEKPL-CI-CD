    ...
    public partial class DaftarBuku : Form
    {
        ...
        private void BTNhapus_Click_1(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(selectedKodeBuku))
            {
                ...
                {
                    daftarBuku = ReadJsonFile("D:\\Coding\\C#\\KPL Clone\\Tubes-KPL-Kelompok05-V.2\\GUI_TUBES_KPL_KELOMPOK-5\\Data\\DataBuku.json");
                    Buku bukuToRemove = daftarBuku.Find(b => b.kodeBuku == selectedKodeBuku);

                    if (bukuToRemove != null)
                    {
                        daftarBuku.Remove(bukuToRemove);
                        WriteJsonFile(daftarBuku, "D:\\Coding\\C#\\KPL Clone\\Tubes-KPL-Kelompok05-V.2\\GUI_TUBES_KPL_KELOMPOK-5\\Data\\DataBuku.json");
                        RefreshDataGridView();
                    }
                }
            }
